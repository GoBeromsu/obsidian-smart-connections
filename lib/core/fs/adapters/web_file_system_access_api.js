 ...
 *    - await smart_fs.list('/');
 */
export class WebFileSystemAccessApiFsAdapter extends SmartFsAdapterBase {
  /**
  ...
  get_file(file_path) {
    ...
    const file = this._build_file_meta(norm_path);
    // Override path since we already normalized
    file.path = norm_path;
